...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setCustomOnClickListener(R.id.fam_attract, TopAttractionsActivity.class);
        setCustomOnClickListener(R.id.museums, BreweriesActivity.class);
        setCustomOnClickListener(R.id.catacombs, FestivalsActivity.class);
    }
